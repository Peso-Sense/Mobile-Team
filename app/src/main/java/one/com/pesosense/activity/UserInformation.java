...
public class UserInformation extends ActionBarActivity implements View.OnClickListener {
    ...
    public void genderItem() {
        ...
        spinnerGender.setPopupBackgroundResource(R.drawable.spinner_bg);
    ...
    public void showDatePicker() {
        ...
        final SimpleDateFormat dateFormat = new SimpleDateFormat( "LLLL", Locale.getDefault() );

        dpd = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            @Override
            public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                Log.d("Pesos Sense", "month: " + month);
